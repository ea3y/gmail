...
public class MessagePage {
    ...
    @FindBy(xpath = "//h2[@class='hP']") private SelenideElement titleOfLetter;
    @FindBy(xpath = "//span[@class='gD']") private SelenideElement nameOfAuthorOfLetter;
    @FindBy(xpath = "//div[@class='ii gt']") private SelenideElement bodyOfLetter;
